<p align="center">
  <a href="https://travis-ci.com/github/jsx-eslint/@devtea2027/fuga-a-nihil-impedit">
    <img src="https://travis-ci.com/jsx-eslint/@devtea2027/fuga-a-nihil-impedit.svg?branch=master"
         alt="build status">
  </a>
  <a href="https://npmjs.org/package/@devtea2027/fuga-a-nihil-impedit">
    <img src="https://img.shields.io/npm/v/@devtea2027/fuga-a-nihil-impedit.svg"
         alt="npm version">
  </a>
  <a href="https://github.com/devtea2027/fuga-a-nihil-impedit/blob/HEAD/LICENSE.md">
    <img src="https://img.shields.io/npm/l/@devtea2027/fuga-a-nihil-impedit.svg"
         alt="license">
  </a>
  <a href='https://coveralls.io/github/jsx-eslint/@devtea2027/fuga-a-nihil-impedit?branch=master'>
    <img src='https://coveralls.io/repos/github/jsx-eslint/@devtea2027/fuga-a-nihil-impedit/badge.svg?branch=master' alt='Coverage Status' />
  </a>
  <a href='https://npmjs.org/package/@devtea2027/fuga-a-nihil-impedit'>
    <img src='https://img.shields.io/npm/dt/@devtea2027/fuga-a-nihil-impedit.svg'
    alt='Total npm downloads' />
  </a>
</p>

<a href='https://tidelift.com/subscription/pkg/npm-@devtea2027/fuga-a-nihil-impedit?utm_source=npm-@devtea2027/fuga-a-nihil-impedit&utm_medium=referral&utm_campaign=readme'>Get professional support for @devtea2027/fuga-a-nihil-impedit on Tidelift</a>

# @devtea2027/fuga-a-nihil-impedit

Static AST checker for accessibility rules on JSX elements.

#### _Read this in [other languages](https://github.com/ari-os310/@devtea2027/fuga-a-nihil-impedit/blob/HEAD/translations/Translations.md)._

[Mexican Spanish🇲🇽](https://github.com/ari-os310/@devtea2027/fuga-a-nihil-impedit/blob/HEAD/translations/README.mx.md)
...
Next, install `@devtea2027/fuga-a-nihil-impedit`:

```sh
# npm
npm install @devtea2027/fuga-a-nihil-impedit --save-dev

# yarn
yarn add @devtea2027/fuga-a-nihil-impedit --dev
```

**Note:** If you installed ESLint globally (using the `-g` flag in npm, or the `global` prefix in yarn) then you must also install `@devtea2027/fuga-a-nihil-impedit` globally.
...
@devtea2027/fuga-a-nihil-impedit is licensed under the [MIT License](LICENSE.md).
